...
public class CrudAppTestSuit {
    private static final String BASE_URL = "https://aniaxs.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        WebDriver driverTrello = WebDriverConfig.getWebDriver(WebDriverConfig.CHROME);
        driverTrello.get(TRELLO_URL);

        driverTrello.findElement(By.id("user")).sendKeys("ania18780380");
        driverTrello.findElement(By.id("password")).sendKeys("Selenium_kurs");
